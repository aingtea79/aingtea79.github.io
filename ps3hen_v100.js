...
function dex()
{
	switch (fwVersion) {
		...
		case "4.85":
			if(document.getElementById('dex').checked===true){loadcex_485();}//alert("calling loadcex_485");
			else {loadcex_485();}
			disable_trigger();
			break;
...
//					initDEX();
				...
				default:
					//alert('Your PS3 is not on FW 4.85! Your current running FW version is ' + fwVersion + ', which is not compatible with ps3hen 1.0. All features have been disabled');
					disable_all();
					break;
			}
			break;
